 ...
 *
 * Precaches the app shell and every species photo so the app works fully
 * offline after the first visit. It replaced the original HTML5 AppCache
 * approach, which browsers removed around 2020-2022. The PRECACHE_URLS list
 * below is regenerated by admin/build.py.
 */

var CACHE_VERSION = 'sgdragonfly-shell-v66';
